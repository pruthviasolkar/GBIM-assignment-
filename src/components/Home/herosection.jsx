  ...
  return (
    <div>
      <div className="herosection">
        <div className='herotxt'><button className='herobtn'><img src="/src/assets/rocket.svg" alt="" />Start Your&nbsp;<span> FREE </span>&nbsp;Trial Now</button></div>
        <div className='contactform'><div className="maincontactform"><div className='formhead'><h3>Contact Us To <span>Grow!</span>
        </h3><img src="/src/assets/growth-chart.svg" alt="" /></div>
          ...
          <button className='formbtn'>SEND <img src="/src/assets/arrowright.png" alt="" /></button>
          </div>
