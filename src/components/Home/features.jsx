        ...
        <>
            <div className='mainfeatures'>
                ...
                <div className="featurelist">
                    <div className='listcard active'><img src="/assets/ranking.svg" alt="" /><h4>Rank <br />
                        Tracking</h4></div>
                    <div className='listcard'><img src="/assets/audit (2).svg" alt="" /><h4>Website <br />
                        Audit
                    </h4></div>
                    <div className='listcard'><img src="/assets/Group 5845.svg" alt="" /><h4>Analytics &<br />
                        Reporting
                    </h4></div>
                    <div className='listcard'><img src="/assets/Group 5846.svg" alt="" /><h4>Performance <br />
                        Marketing
                    </h4></div>
                    <div className='listcard'><img src="/assets/Glyph.png" alt="" /><h4>Social Media<br />
                        Scheduling <br />
                        And Insight</h4></div>
                    <div className='listcard'><img src="/assets/Group 5847.svg" alt="" /><h4>Competitor <br />
                        Analysis</h4></div>
                </div>
                <div className='mainrank'>
                    <img className="dotimg1" src="/assets/Group 5855.png" alt="" />
                    <div className='ranktracking'>
                        ...
                        <div className='rankright'><img src="/assets/Group 24104.svg" alt="" /></div>
                    </div>
                    <img  className="dotimg2"src="/assets/Group 5855.png" alt="" />
                </div>
